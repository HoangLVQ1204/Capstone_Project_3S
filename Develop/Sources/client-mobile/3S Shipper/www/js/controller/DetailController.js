...
app.directive('map', function () {
  ...
  .controller('DetailCtrl', ['$scope', '$stateParams', 'dataService', '$cordovaGeolocation', '$ionicPopup', '$ionicModal', '$ionicPopover', function ($scope, $stateParams, dataFactory, $cordovaGeolocation, $ionicPopup, $ionicModal, $ionicPopover) {
