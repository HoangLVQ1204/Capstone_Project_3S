...
(
username varchar(8) REFERENCES Users(username) PRIMARY KEY,
name varchar(50),
...
(
managerID varchar(8) REFERENCES Users(username),
...
adminID varchar(8) REFERENCES Users(username),
storeID varchar(8) REFERENCES Store(storeID),
amount BIGINT,
balance BIGINT,
payDate timestamp,
...
storeID varchar(8) REFERENCES Store(storeID),
shipperID varchar(8) REFERENCES Users(username),
...
updater varchar(8) REFERENCES Users(username)
);
