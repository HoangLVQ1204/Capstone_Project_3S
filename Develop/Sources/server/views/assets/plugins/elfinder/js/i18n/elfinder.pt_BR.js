...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.pt_BR = {
		...
		messages   : {
			...
			'errUploadCommon'      : 'Erro no avatar.',
			'errUpload'            : 'Incapaz de fazer o avatar de "$1".',
			'errUploadNoFiles'     : 'Não foi encontrado nenhum arquivo para avatar.',
			...
			'cmdupload'    : 'Fazer avatar de arquivo',
			'cmdview'      : 'Vizualizar',
			...
			'ntfupload'   : 'Fazendo o avatar dos arquivos',
			...
			'or'              : 'ou',
			'selectForUpload' : 'Selecione arquivos para avatar',
