...
function storeOrderController($state,$scope, dataService, config, socketService, socketStore) {
    getStoreName();
    getProvince ();
...
storeOrderController.$inject = ['$state','$scope', 'dataService', 'config','socketService','socketStore'];
