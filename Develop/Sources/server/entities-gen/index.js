...
var db = {};
//var tmp = globber.getGlobbedFiles('./entities/*.js');
//delete tmp[tmp.indexOf('./entities/index.js')];
//    var tmp = globber.getGlobbedFiles('./entities/**/!(index.js)');
//
//    console.log("Globber: "+ typeof tmp);
//    console.log("Globber: "+ tmp.indexOf("./entities/index.js"));
